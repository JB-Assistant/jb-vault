...
**Source:** Aparna Dhinakaran (@aparnadhinak)  
**Date:** 2026-04-29  
**Original date:** Wed Apr 22 15:53:41 +0000 2026  
**Link:** https://x.com/aparnadhinak/status/2046980769747533830  
**Stats at capture:** 99,297 views, 658 likes, 1,718 bookmarks, 102 reposts
...
_[Image/diagram: Harness Architecture]_
...
_[Image/diagram: Core While Loop]_
...
_[Image/diagram: Context Management]_
...
_[Image/diagram: SubAgent Management]_
...
_[Image/diagram: Skills and tools]_
...
_[Image/diagram: System Prompt Assembly]_
...
_[Image/diagram: permission layer]_
...
- https://pbs.twimg.com/media/HGhTWVbbAAEgP9-.jpg
- https://pbs.twimg.com/media/HGhVPuqbQAAoOn9.jpg
- https://pbs.twimg.com/media/HGhSl9paUAADag8.jpg
- https://pbs.twimg.com/media/HGhVEr8bkAA3VWd.jpg
- https://pbs.twimg.com/media/HGhUAGGa8AAAGCE.jpg
- https://pbs.twimg.com/media/HGhTm8RakAAFQI0.jpg
- https://pbs.twimg.com/media/HGhUcxGbgAAnYIN.jpg

---

## Summary

Aparna Dhinakaran argues that an agent harness is not the same thing as a framework like LangChain or LangGraph. Frameworks are built for humans to configure agents; harnesses ship as working agent systems that let a model operate in a closed loop with tools, permissions, context management, persistence, and sub-agents.

Her definition: a harness is the architecture around the model that lets it act, observe results, adjust, and keep going until a task is complete. Successful harnesses converge on components like an outer tool loop, context compression, skills/tools management, sub-agent isolation, session recovery, dynamic system prompt assembly, lifecycle hooks, and permission/safety layers.

---

## Key Takeaways

1. LangChain/LangGraph are frameworks: human-configured abstractions for building agents, not harnesses.
2. A harness ships as a working agent architecture out of the box: loop, tools, context manager, permissions, and persistence already wired together.
3. The core primitive is the outer iteration loop: model decides, calls tools, observes, and repeats until done.
4. Context management and compression are first-class harness responsibilities, not afterthoughts.
5. Tools are universal primitives; skills encode team/workflow-specific knowledge on top of tools.
6. Sub-agents need isolation: separate session/context/tool permissions so they do not corrupt the parent agent.
7. Enterprise adoption depends on hooks and permission layers: pre/post tool controls, audit logging, approvals, and policy enforcement.
8. The key shift is closed-loop agency: a model inside a harness can act on feedback instead of generating one-shot text.

---

## Hermes-Related Interest

Extremely relevant to Hermes. This article is basically a clean vocabulary for what Hermes is becoming: not just a chat interface, but an agent harness with tools, skills, context injection, subagents, cron jobs, persistence, and safety rules. It also suggests a product positioning angle: for service-business SaaS, the moat is not the model; it is the harness around the model — permissions, shop-specific context, repeatable skills, workflow hooks, and safe closed-loop execution.
