...
**Source:** João Moura (@joaomdmoura)  
**Date:** 2026-04-29  
**Original date:** Wed Apr 29 18:50:44 +0000 2026  
**Link:** https://x.com/joaomdmoura/status/2049562041007194275  
**Stats at capture:** 3,481 views, 39 likes, 66 bookmarks, 6 reposts
...
- Memory for canonical abstract learning (using our Cognitive Memory)

- Skills for encoding non deterministic workflows

- CrewAI Flows for encoding deterministic workflows

_[Attached media/diagram preserved in source post]_
...
- https://pbs.twimg.com/media/HHF_Zp0bAAAcw8c.jpg
- https://pbs.twimg.com/media/HHF_kEcaoAEJu-A.jpg
- https://pbs.twimg.com/media/HHGBgpFb0AAaccy.jpg

---

## Summary

João Moura describes CrewAI’s internal AI employee, Iris, as a production test of 'entangled agents': agents that evolve with the organizations they serve. Iris is Slack-native, writes code, files and reviews PRs, persists memory across conversations, can modify its own code, and uses CrewAI Flows, Agents, Crews, and Memory.

The thesis is that usage creates memory; memory creates skills and deterministic flows; those skills/flows make the agent better over time. The hard lesson is that self-building agents need filters, provenance, lightweight execution paths, aging memory, and trust-building behavior—not just impressive demos.

---

## Key Takeaways

1. Entangled agents evolve with the organization instead of staying as static tools.
2. Iris combines canonical memory, skill creation, deterministic CrewAI Flows, and multi-agent collaboration in production.
3. Nightly 'dreaming' reviews conversations, clusters topics, and canonicalizes stable facts into memory.
4. Repeated approaches become skills; repeated sequential tool patterns become deterministic flows.
5. Self-improvement requires review/approval filters because generated behavioral rules can be wrong.
6. Production agents lose trust faster than humans; honesty and quiet self-correction matter more than demo flash.
7. Memory needs provenance and aging; agents must know where knowledge came from and when it may be stale.
8. Agents should delegate repeated processes to encoded flows instead of reasoning from scratch every time.
9. CrewAI reports AI agents authoring roughly one in four PRs across the organization, freeing humans for architecture, design, and judgment.
10. The agents that matter will be the ones that survive production, not the ones with the best demos.

---

## Hermes-Related Interest

Highly relevant to Hermes/JB Vault. This is the same compounding loop from the recent Hermes/OpenClaw articles, but with CrewAI’s vocabulary: organizational world model, canonical memory, skill generation, deterministic flows, and provenance. For Junaid’s products, the lesson is to make shop agents entangled with each shop: learn reliable credential/contact sources, know staff roles, convert repeated service workflows into approved playbooks, age out stale memory, and keep a provenance trail for every automated decision.
